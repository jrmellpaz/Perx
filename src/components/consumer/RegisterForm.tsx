...
import { Step1Schema, Step2Schema, Step3Schema, Inputs } from "@/lib/consumerSchema"
...
function Step3({
  ...
  const interests = ["Shopping", "Coffee", "Shoes", "Clothes", "Food", "Others"];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        {showOtherInput && (
          <div className="mt-2">
            <label htmlFor="otherInterest" className="block text-sm font-medium">
      ...
      {errors.interests && (
        <p className="text-red-500 text-sm">
          {errors.interests.message?.toString() || "Please select at least one interest."}
        </p>
      )}
    </motion.div>
  );
